...
import com.cjmkeke.d2rbooks.databinding.ActivityAmericaUberDiabloSettingsBinding;

public class AmericaUberDiabloSettings extends AppCompatActivity {

    private static final String TAG = "AmericaUberDiabloSettings";
    private ActivityAmericaUberDiabloSettingsBinding mBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = ActivityAmericaUberDiabloSettingsBinding.inflate(getLayoutInflater());
//        EdgeToEdge.enable(this);
        setContentView(mBinding.getRoot());

//        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.uber_root_main_america), (v, insets) -> {
...
//        });
        ...
        mBinding.cbLadderHardcore3.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_LADDER_HARD_CORE_3, false));
        ...
        mBinding.cbLadderHardcore3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_LADDER_HARD_CORE_3);
            }
        });

        mBinding.cbLadderHardcore4.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_LADDER_HARD_CORE_4, false));
        ...
        mBinding.cbLadderHardcore4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_LADDER_HARD_CORE_4);
            }
        });

        mBinding.cbLadderHardcore5.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_LADDER_HARD_CORE_5, false));
        ...
        mBinding.cbLadderHardcore5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_LADDER_HARD_CORE_5);
            }
        });

        mBinding.cbLadderHardcore6.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_LADDER_HARD_CORE_6, false));
        ...
        mBinding.cbLadderHardcore6.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_LADDER_HARD_CORE_6);
            }
        });

        mBinding.cbLadderSoftcore3.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_LADDER_SOFT_CORE_3, false));
        ...
        mBinding.cbLadderSoftcore3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_LADDER_SOFT_CORE_3);
            }
        });

        mBinding.cbLadderSoftcore4.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_LADDER_SOFT_CORE_4, false));
        ...
        mBinding.cbLadderSoftcore4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_LADDER_SOFT_CORE_4);
            }
        });

        mBinding.cbLadderSoftcore5.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_LADDER_SOFT_CORE_5, false));
        ...
        mBinding.cbLadderSoftcore5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_LADDER_SOFT_CORE_5);
            }
        });

        mBinding.cbLadderSoftcore6.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_LADDER_SOFT_CORE_6, false));
        ...
        mBinding.cbLadderSoftcore6.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_LADDER_SOFT_CORE_6);
            }
        });

        mBinding.cbNoneLadderHardcore3.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_NONE_LADDER_HARD_CORE_3, false));
        ...
        mBinding.cbNoneLadderHardcore3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_NONE_LADDER_HARD_CORE_3);
            }
        });

        mBinding.cbNoneLadderHardcore4.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_NONE_LADDER_HARD_CORE_4, false));
        ...
        mBinding.cbNoneLadderHardcore4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_NONE_LADDER_HARD_CORE_4);
            }
        });

        mBinding.cbNoneLadderHardcore5.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_NONE_LADDER_HARD_CORE_5, false));
        ...
        mBinding.cbNoneLadderHardcore5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_NONE_LADDER_HARD_CORE_5);
            }
        });

        mBinding.cbNoneLadderHardcore6.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_NONE_LADDER_HARD_CORE_6, false));
        ...
        mBinding.cbNoneLadderHardcore6.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_NONE_LADDER_HARD_CORE_6);
            }
        });

        mBinding.cbNoneLadderSoftcore3.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_NONE_LADDER_SOFT_CORE_3, false));
        ...
        mBinding.cbNoneLadderSoftcore3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_NONE_LADDER_SOFT_CORE_3);
            }
        });

        mBinding.cbNoneLadderSoftcore4.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_NONE_LADDER_SOFT_CORE_4, false));
        ...
        mBinding.cbNoneLadderSoftcore4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_NONE_LADDER_SOFT_CORE_4);
            }
        });

        mBinding.cbNoneLadderSoftcore5.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_NONE_LADDER_SOFT_CORE_5, false));
        ...
        mBinding.cbNoneLadderSoftcore5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_NONE_LADDER_SOFT_CORE_5);
            }
        });

        mBinding.cbNoneLadderSoftcore6.setChecked(uberSharedPreferences.getBoolean(SharedValue.AMERICA_NONE_LADDER_SOFT_CORE_6, false));
        ...
        mBinding.cbNoneLadderSoftcore6.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                applySettings(isChecked, uberEditor, SharedValue.AMERICA_NONE_LADDER_SOFT_CORE_6);
            }
        });
