...
public class DruidSummoning10 {

    static final String JSON_FILE_NAME = "druid_summoning10.json";

    public static void skillUpdate(int value, TextView textView, Context context, SharedPreferences sharedPreferences){
        Type listType = new TypeToken<List<DruidSummoning2.Models>>() {}.getType();
        List<DruidSummoning2.Models> skill = JsonUtil.loadJSONFromAsset(context, JSON_FILE_NAME, listType);
        Spanned spanned;
