...
public class RareHideAndShow {
    ...
    public RareHideAndShow(Context context, List<String> optionsSuffix, List<String> optionsPrefix, String[] addOptionsPrefix, String[] addOptionsSuffix, TextView textView) {
    ...
    public void removeSuffix(List<String> optionsSuffix, String[] addOptionsSuffix, int num, TextView textView) {
        ...
        if (itemType.equals("ring")) {
            addRingViewOptions(optionsSuffix, optionsPrefix);
        } else if (itemType.equals("amulet")) {
            addAmuletViewOptions(optionsSuffix, optionsPrefix);
        } else if (itemType.equals("helmet")) {
            addHelmetViewOptions(optionsSuffix, optionsPrefix);
        } else if (itemType.equals("weapons")) {
            addWeaponsViewOptions(optionsSuffix, optionsPrefix);
        } else if (itemType.equals("jewel")) {
            addJewelViewOptions(optionsSuffix, optionsPrefix);
        } else if (itemType.equals("glove")) {
            addGloveViewOptions(optionsSuffix, optionsPrefix);
        } else if (itemType.equals("boots")) {
            addBootsViewOptions(optionsSuffix, optionsPrefix);
        }
    }
    ...
    public void addSuffix(List<String> optionsSuffix, String[] addOptionsSuffix, int num, TextView textView) {
        ...
        if (optionsSuffix.size() == 3) {
            Toast.makeText(context, "접미사를 3개 이상 초과할수 없습니다.", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        // 아이템 유형별 처리
        if (itemType.equals("ring")) {
            addRingViewOptions(optionsPrefix, optionsSuffix);
        } else if (itemType.equals("amulet")) {
            addAmuletViewOptions(optionsPrefix, optionsSuffix);
        } else if (itemType.equals("helmet")) {
            addHelmetViewOptions(optionsSuffix, optionsPrefix);
        } else if (itemType.equals("weapons")) {
            addWeaponsViewOptions(optionsSuffix, optionsPrefix);
    ...
    public void addPreFix(List<String> optionsPrefix, String[] addOptionsPrefix, int num, TextView textView) {
        ...
        // 조건 검사
        if (optionsPrefix.size() >= 3) { // 조건 수정
            Toast.makeText(context, "접두사를 3개 이상 초과할수 없습니다.", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void addRingViewOptions(List<String> amuletOptionsSuffix, List<String> amuletOptionsPrefix) {
        ...
        if (str == null || str.isEmpty() || str.equals("")) {
            textView.setText(context.getString(R.string.ring_title));
        } else {
            textView.setText(str);
        }
    }

    private void addAmuletViewOptions(List<String> amuletOptionsSuffix, List<String> amuletOptionsPrefix) {
        StringBuilder sb = new StringBuilder();
        ...
        if (str == null || str.isEmpty() || str.equals("")) {
            textView.setText(context.getString(R.string.amulet_title));
        } else {
            textView.setText(str);
        }    }

    private void addHelmetViewOptions(List<String> amuletOptionsSuffix, List<String> amuletOptionsPrefix) {
        StringBuilder sb = new StringBuilder();
        ...
        if (str == null || str.isEmpty() || str.equals("")) {
            textView.setText(context.getString(R.string.helmet_title));
        } else {
            textView.setText(str);
        }    }

    private void addWeaponsViewOptions(List<String> amuletOptionsSuffix, List<String> amuletOptionsPrefix) {
        StringBuilder sb = new StringBuilder();
        ...
        if (str == null || str.isEmpty() || str.equals("")) {
            textView.setText(context.getString(R.string.weapons_title));
        } else {
            textView.setText(str);
        }
    ...
    private void addGloveViewOptions(List<String> amuletOptionsSuffix, List<String> amuletOptionsPrefix) {
        StringBuilder sb = new StringBuilder();
    ...
    private void addBootsViewOptions(List<String> amuletOptionsSuffix, List<String> amuletOptionsPrefix) {
        StringBuilder sb = new StringBuilder();
