...
public class CombatUpdate {
    ...
    public static String combatSkill1(String 레벨, String 자신에게피해, String 현재명중률, String 현재공격력, String 다음명중률, String 다음공격력) {
        return
    ...
    public static String combatSkill2(String 레벨, String 현재공격력, String 현재기절지속시간, String 다음공격력, String 다음기절지속시간) {
        return
    ...
    public static String combatSkill3(String 레벨, String 현재마법피해, String 현재치유, String 현재마나소모, String 다음마법피해, String 다음치유, String 다음마나소모) {
        return
    ...
    public static String combatSkill4(String 레벨, String 현재적중, String 현재적중률, String 현재공격력, String 다음적중, String 다음적중률, String 다음공격력) {
        return
    ...
    public static String combatSkill5(String 레벨, String 현재명중률, String 현재공격력, String 다음명중률, String 다음공격력) {
        return
    ...
    public static String combatSkill6(String 레벨, String 현재명중률, String 현재화염피해, String 현재냉기피해, String 현재냉기지속시간, String 현재번개피해, String 현재마나소모, String 다음명중률, String 다음화염피해, String 다음냉기피해, String 다음냉기지속시간, String 다음번개피해, String 다음마나소모) {
        return
    ...
    public static String combatSkill7(String 레벨, String 현재마법피해, String 현재마나소모, String 다음마법피해, String 다음마나소모) {
        return
    ...
    public static String combatSkill8(String 레벨, String 현재전향확률, String 다음전향확률) {
        return
    ...
    public static String combatSkill9(String 레벨, String 현재강타피해, String 현재방어력, String 현재막기성공확률, String 현재지속시간, String 다음강타피해, String 다음방어력, String 다음막기성공확률, String 다음지속시간) {
        return
    ...
    public static String combatSkill10(String 레벨, String 현재번개피해, String 현재신성한빛줄기피해, String 다음번개피해, String 다음신성한빛줄기피해) {
        return
