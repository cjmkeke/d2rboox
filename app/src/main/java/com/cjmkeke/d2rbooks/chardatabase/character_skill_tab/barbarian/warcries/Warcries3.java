...
public class Warcries3 {

    static final String JSON_FILE_NAME = "warcries3.json";
    ...
    public static void skillUpdate(int value, TextView textView, Context context, SharedPreferences sharedPreferences) {
        ...
        if (skill != null) {
            if (value == 20) {
                if (value == 20) {
                    spanned = Html.fromHtml(WarcriesUpdate.warcriesSkill3_end(
                                    "20",
                ...
                for (int i = 0; i < 21; i++) {
                    if (value == i) {
                        spanned = Html.fromHtml(WarcriesUpdate.warcriesSkill3(
                                        String.valueOf(i),
