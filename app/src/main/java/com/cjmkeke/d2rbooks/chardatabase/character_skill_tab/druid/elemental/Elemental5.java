...
public class Elemental5 {

    static final String JSON_FILE_NAME = "elemental5.json";
    ...
    public static void skillUpdate(int value, TextView textView, Context context, SharedPreferences sharedPreferences){
        ...
        if (skill != null){
            if (value == 20) {
                if (value == 20) {
                    spanned = Html.fromHtml(ElementalUpdate.elementalSkill5_end(
                                    "20",
                ...
                for (int i = 0; i < 21; i++) {
                    if (value == i) {
                        spanned = Html.fromHtml(ElementalUpdate.elementalSkill5(
                                        String.valueOf(i),
