...
public class Lightning5 {

    static final String JSON_FILE_NAME = "lightning5.json";
    ...
    public static void skillUpdate(int value, TextView textView, Context context, SharedPreferences sharedPreferences){
        ...
        if (skill != null){
            if (value == 20) {
                if (value == 20) {
                    spanned = Html.fromHtml(LightningUpdate.lightningSkill5_end(
                                    "20",
                ...
                for (int i = 0; i < 21; i++) {
                    if (value == i) {
                        spanned = Html.fromHtml(LightningUpdate.lightningSkill5(
                                        String.valueOf(i),
                                        skill.get(i - 1).getOption1(), // 공격력
                                        skill.get(i - 1).getOption2(), // 공격력
                                        skill.get(i).getOption1(), // 공격력
