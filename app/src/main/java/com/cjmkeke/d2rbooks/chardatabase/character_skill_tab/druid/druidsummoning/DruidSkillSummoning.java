...
public class DruidSkillSummoning {

    public static String druidSkillSummoningSkill1 =
    ...
    public static String druidSkillSummoningSkill2 =
    ...
    public static String druidSkillSummoningSkill3 =
    ...
    public static String druidSkillSummoningSkill4 =
    ...
    public static String druidSkillSummoningSkill5 =
    ...
    public static String druidSkillSummoningSkill6 =
    ...
    public static String druidSkillSummoningSkill7 =
    ...
    public static String druidSkillSummoningSkill8 =
    ...
    public static String druidSkillSummoningSkill9 =
    ...
    public static String druidSkillSummoningSkill10 =
    ...
    public static String druidSummoningSkill1_end =
         "<font color='#48AE4A'>큰까마귀</font>" +
                "<br>큰까마귀를 소환하여<br>적의 눈을 파먹게 합니다." +
                "<br>최대 레벨 도달" +
                "<br><br>큰까마귀 한마리당 마나 소모: 6" +
    ...
    public static String druidSummoningSkill2_end=
         "<font color='#48AE4A'>맹독 덩굴</font>" +
                "<br>접촉하는 적에게 질병을<br>퍼트리는 덩굴을 소환합니다." +
                "<br>최대 레벨 도달" +
                "<br><br>마나 소모: 8" +
    ...
    public static String druidSummoningSkill3_end =
        "<font color='#48AE4A'>참나무 현자</font>" +
                "<br>영혼 소환수를 소환하여<br>자신과 파티원의 생명력을 증가시킵니다." +
                "<br>최대 레벨 도달" +
                "<br><br>현재 기술 레벨: 20" +
    ...
    public static String druidSummoningSkill4_end =
         "<font color='#48AE4A'>영혼 늑대 소환</font>" +
                "<br>순간이동 능력이 있는 늑대를 소환하여<br>전투를 돕게 합니다." +
                "<br>최대 레벨 도달" +
                "<br><br>마나 소모: 15" +
    ...
    public static String druidSummoningSkill5_end =
            "<font color='#48AE4A'>청소부 덩굴</font>" +
                "<br>시체를 먹어 플레이어의 생명력의 회복시키는<br>덩굴을 소환합니다." +
                "<br>최대 레벨 도달" +
                "<br><br>마나 소모: 10" +
    ...
    public static String druidSummoningSkill6_end =
            "<font color='#48AE4A'>울버린의 심장</font>" +
                "<br>영혼 소환수를 소환하여<br>자신과 파티원의 공격력과<br>명중률을 증가시킵니다." +
                "<br>최대 레벨 도달" +
                "<br><br>현재 기술 레벨: 20" +
    ...
    public static String druidSummoningSkill7_end =
            "<font color='#48AE4A'>광포한 늑대 소환</font>" +
                "<br>광포한 늑대를 소환합니다.<br>늑대는 시체를 먹어<br>적에게 더 큰 피해를 줍니다." +
                "<br>최대 레벨 도달" +
                "<br><br>마나 소모: 20" +
    ...
    public static String druidSummoningSkill8_end = "<font color='#48AE4A'>태양의 덩굴</font>" +
                "<br>시체를 먹어 플레이어의 마나를 회복시키는<br>덩굴을 소환합니다." +
                "<br>최대 레벨 도달" +
                "<br><br>현재 기술 레벨: 20" +
                "<br>생명력: 165" +
    ...
    public static String druidSummoningSkill9_end =
            "<font color='#48AE4A'>가시의 영혼</font>" +
                "<br>영혼 소환수를 소환하여<br>자신과 파티원이 받는 피해를<br>적에게 되돌려 줍니다." +
                "<br>최대 레벨 도달" +
                "<br><br>현재 기술 레벨: 20" +
