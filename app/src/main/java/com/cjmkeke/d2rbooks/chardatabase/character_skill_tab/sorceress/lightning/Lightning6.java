...
public class Lightning6 {

    static final String JSON_FILE_NAME = "lightning6.json";
    ...
    public static void skillUpdate(int value, TextView textView, Context context, SharedPreferences sharedPreferences){
        ...
        if (skill != null){
            if (value == 20) {
                if (value == 20) {
                    spanned = Html.fromHtml(LightningUpdate.lightningSkill6_end(
                                    "20",
                ...
                for (int i = 0; i < 21; i++) {
                    if (value == i) {
                        spanned = Html.fromHtml(LightningUpdate.lightningSkill6(
                                        String.valueOf(i),
