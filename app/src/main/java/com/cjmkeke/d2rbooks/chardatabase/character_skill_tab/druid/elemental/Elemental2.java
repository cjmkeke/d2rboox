...
public class Elemental2 {
    ...
    static final String JSON_FILE_NAME = "elemental2.json";
    ...
    public static void skillUpdate(int value, TextView textView, Context context, SharedPreferences sharedPreferences) {
        ...
        if (skill != null) {
            ...
            if (skill != null) {
                if (value == 20) {
                    if (value == 20) {
                        spanned = Html.fromHtml(ElementalUpdate.elementalSkill2_end(
                                        "20",
                                        skill.get(20).getOption1(),
                                        skill.get(20).getOption2(),
                                        skill.get(20).getOption3(),
                                        skill.get(20).getOption4(),
                                        null,
                                        null,
                                        null,
                                        null,
                    ...
                    for (int i = 0; i < 21; i++) {
                        if (value == i) {
                            spanned = Html.fromHtml(ElementalUpdate.elementalSkill2(
                                            String.valueOf(i),
