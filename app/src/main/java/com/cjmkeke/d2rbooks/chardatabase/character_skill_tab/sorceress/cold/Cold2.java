...
public class Cold2 {
    ...
    static final String JSON_FILE_NAME = "cold2.json";
    ...
    public static void skillUpdate(int value, TextView textView, Context context, SharedPreferences sharedPreferences) {
        ...
        if (skill != null) {
            ...
            if (skill != null) {
                if (value == 20) {
                    if (value == 20) {
                        spanned = Html.fromHtml(ColdUpdate.coldSkill2_end(
                                        "20",
