...
public class ImageUpdate {
    ...
    public void skillPreviewDialog(Context context, Spanned spanned, int id) {
        ...
        TextView textView = dialog.findViewById(R.id.tv_btn_added_skill);
    ...
    public void skillPreviewDialog(Context context, Spanned spanned, int id, TextView[] textViews, String characterName, String SKILL_POINT_KEY, String SKILL_TABLE_NAME, String SKILL_POINT_QUEST_COMPLETE_KEY, String[] SKILL_TABLE_ARRAY, int[] skillPoints, SharedPreferences sharedPreferences,  String imageNumber, ImageView ivBtnSkillImage, TextView tvViewValue, boolean checkSkillConditions ) {
        Dialog dialog = new Dialog(context);
        dialog.setContentView(R.layout.skill_preview_paladins_defense);
        TextView skillPreview = dialog.findViewById(R.id.tv_preview);
        ImageView imageView = dialog.findViewById(R.id.iv_skill_preview);
