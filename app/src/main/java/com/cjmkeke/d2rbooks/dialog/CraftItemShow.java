...
import com.cjmkeke.d2rbooks.databinding.ActivityCraftItemShowBinding;

public class CraftItemShow extends Activity {

    private ActivityCraftItemShowBinding mBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBinding = ActivityCraftItemShowBinding.inflate(getLayoutInflater());
        ...
        if (intent.getStringExtra("item1") != null) {
            ...
            int res = getResources().getIdentifier(item1, "drawable", getPackageName());
            mBinding.ivIntentImg.setBackgroundResource(res);
        } else {
            Log.w("ItemShow", "데이터가 없습니다.");
        }

        String types = intent.getStringExtra("type");
        mBinding.tvIntentItemType.setText(types);
    }
