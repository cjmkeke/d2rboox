...
public class Lightning8 {

    static final String JSON_FILE_NAME = "lightning8.json";
    ...
    public static void skillUpdate(int value, TextView textView, Context context, SharedPreferences sharedPreferences){
        ...
        if (skill != null){
            if (value == 20) {
                if (value == 20) {
                    spanned = Html.fromHtml(LightningUpdate.lightningSkill8_end(
                                    "20",
                ...
                for (int i = 0; i < 21; i++) {
                    if (value == i) {
                        spanned = Html.fromHtml(LightningUpdate.lightningSkill8(
                                        String.valueOf(i),
